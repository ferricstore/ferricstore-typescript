...
const FLOW_ADMIN_FIELDS: Readonly<Record<string, string>> = {
  ...
  MAX_ACTIVE_MS: "max_active_ms", MAX_FIRES: "max_fires", MAXBYTES: "payload_max_bytes", NOW: "now_ms", OPEN_MS: "open_ms",
  OPERATION_DIGEST: "operation_digest", OVERLAP_POLICY: "overlap_policy", OVERLAP_RETRY_MS: "overlap_retry_ms",
  OVERWRITE: "overwrite", PARENT_FLOW_ID: "parent_flow_id", PARTITION: "partition_key",
  ...
  RETURN: "return", ROOT_FLOW_ID: "root_flow_id", SCOPE: "scope", SHARD_ID: "shard_id",
